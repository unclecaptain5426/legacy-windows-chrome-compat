...
| 2.0.178.0 | GetNativeSystemInfo (KERNEL32.DLL) | Introduced in Windows XP build 2481 | Requires workarounds for Windows XP build 2475 and lower (like changing the function to GetSystemInfo)
...
| 5.0.366.0 | CancelIPChangeNotify (IPHLPAPI.DLL) | Introduced in Windows XP SP2 builds | Introduced in Windows XP build 2481 | Requires workarounds for Windows XP build 2475 and lower (like drag+drop IPHLPAPI.DLL and ICMP.DLL from XP SP3 to the Chrome-bin folder)
