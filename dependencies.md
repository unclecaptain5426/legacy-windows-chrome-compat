...
| 5.0.366.0 | CancelIPChangeNotify (IPHLPAPI.DLL) | Introduced in Windows XP SP2 builds | Requires workarounds for Windows XP SP1 and lower (like drag+drop IPHLPAPI.DLL and ICMP.DLL from XP SP3 to the Chrome-bin folder)
